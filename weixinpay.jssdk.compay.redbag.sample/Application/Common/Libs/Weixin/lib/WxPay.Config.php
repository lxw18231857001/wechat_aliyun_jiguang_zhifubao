...
//证书
defined('SSLCERT_PATH') || define('SSLCERT_PATH', realpath( dirname(__FILE__).'/../' ).'/cert/apiclient_cert.pem') ;
defined('SSLKEY_PATH') || define('SSLKEY_PATH',  realpath( dirname(__FILE__).'/../' ).'/cert/apiclient_key.pem' );
//提交IP
